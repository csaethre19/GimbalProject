...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, eeprom_wp_Pin|EN_BLDC2_Pin|EN_BLDC1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : eeprom_wp_Pin EN_BLDC2_Pin EN_BLDC1_Pin */
  GPIO_InitStruct.Pin = eeprom_wp_Pin|EN_BLDC2_Pin|EN_BLDC1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
